 ...
 *
 */
public class RectangularTriangle extends ABaseAndHeightFigure {
    /**
     *
     */
     ...
     * Default constructor
     */
    public RectangularTriangle(Point2D reference, int sideNumber) {
    ...
    public void setPointAt(int pos, Point2D point) {
        ...
        if (pos == 2) {
            ...
            super.setPointAt(2, points[1].add(vector.getX() * Math.cos(angle) - vector.getY() * Math.sin(angle),
